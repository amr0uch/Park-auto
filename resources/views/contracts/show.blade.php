            ...
            <div class="card-body">
                <div id="invoice">
                    <div class="toolbar hidden-print">
                        <div class="text-right"><a href="/exportPDF/{{$contractss->id}}" class="btn btn-success"> <i class='bx bx-export'></i> Exporter PDF</a>
                            ...
                            <header>
                                <div class="row">
                                    ...
                                    GALV
                                        ...
                                        <div>{{$contractss->debut_contract}} :Date debut de location </div>
                                        <div> {{$contractss->end_contract}} :Date fin de location </div>
                                        <div>autoloc@gmail.com</div>
                                    </div>
                                </div>
                            </header>
                            <main>
                                <div class="row contacts">
                                    <div class="col invoice-to">
                                        <table border="0" style="border-collapse: collapse; width: 100%; height: 449px;">
                                            ...
                                            <div><span>Le&nbsp;</span><span>loueur</span><span>&nbsp;met &agrave; disposition du&nbsp;</span><span>locataire</span><span>, un véhicule de marque <b>{{$contractss->car->model}} </b>, immatriculé <b>{{$contractss->car->registration}} </b></span><span></span><br /><br /></div>
                                            <div>
                                            ...
                                            <div><span>Les parties s'entendent sur un prix de location <b>{{$contractss->amount}}</b> Dirham&nbsp;.et <b>{{$contractss->car->price_day}}</b> Dirham par jour (calendaires).</span></div>
                                            <div>
                                            ...
                                            <div><strong>Le locataire&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Le Loueur</strong><span></span></div>
